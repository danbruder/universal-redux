...
function create(providedMiddleware, data) {
  ...
  if (__CLIENT__) {
    var enhancer = (0, _redux.compose)(_redux.applyMiddleware.apply(undefined, (0, _toConsumableArray3.default)(middleware)), (0, _reduxLocalstorage2.default)());

    var _store = (0, _redux.createStore)(_modules2.default, data, enhancer);
  } else {
    var _store2 = (0, _redux.createStore)(_modules2.default, data);
  }
